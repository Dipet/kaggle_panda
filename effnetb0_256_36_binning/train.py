...
class Model(LightningModule):
    ...
    def train_dataloader(self):
        dataset = TrainDatasetBinning(self.train_df, self.data_dir, self.train_transforms, 1, IMAGE_SIZE, NUM_TILES)
    ...
    def val_dataloader(self):
        dataset = TrainDatasetBinning(self.valid_df, self.data_dir, self.valid_transforms, 1, IMAGE_SIZE, NUM_TILES, random=False)
